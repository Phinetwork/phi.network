...
function lockedCreate(mutex$10, binary, hashLength) {
	return __awaiter(this, void 0, void 0, function* () {
		const unlock = yield mutex$10.lock();
...
var uint32View = /* @__PURE__ */ new DataView(/* @__PURE__ */ new ArrayBuffer(4));
function int32LE(x) {
...
function argon2Internal(options) {
	return __awaiter(this, void 0, void 0, function* () {
		...
		const secret = getUInt8Buffer((_a$1 = options.secret) !== null && _a$1 !== void 0 ? _a$1 : "");
...
var validateOptions$3 = (options) => {
	...
	options.secret = getUInt8Buffer((_a$1 = options.secret) !== null && _a$1 !== void 0 ? _a$1 : "");
...
var validateHashCharacters = (hash) => {
